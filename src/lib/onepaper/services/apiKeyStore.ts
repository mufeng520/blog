...
const API_SETTINGS_KEY = 'onepaper-api-settings';
const REQUEST_LOGS_KEY = 'onepaper-request-logs';

// Legacy keys for migration
const LEGACY_API_KEY = 'onepaper-gemini-api-key';
const LEGACY_BASE_URL = 'onepaper-gemini-base-url';
const LEGACY_TEXT_MODEL = 'onepaper-text-model';
const LEGACY_IMAGE_MODEL = 'onepaper-image-model';
