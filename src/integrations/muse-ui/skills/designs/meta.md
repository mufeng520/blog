...
- **Dark Overlay Gradient**: `linear-gradient(rgba(0,0,0,0), rgba(0,0,0,0.6))` â€” applied over dark product photography for text legibility
- **Blue Infinity Gradient**: The Meta symbol uses a blue-to-teal gradient on brand materials, though the store uses flat blue
- **Shadow Alpha Scale**: 0.05, 0.10, 0.15, 0.20, 0.30, 0.40, 0.50, 0.60, 0.80 â€” both black and white alpha ramps for layered transparency
...
- OpenType features: `"ss01", "ss02"` â€” stylistic sets that activate Meta-specific alternate glyphs
...
- **Glimmer loading states**: Pulsating opacity animation (0.25 â†’ 1.0) on `#979A9F` base color with 8px radius, 1000ms steps timing â€” used for skeleton screens during product image loading
...
- Let product photography dominate â€” make images the visual hero of every section
...
- Keep body copy brief and scannable â€” this is retail, not editorial
...
- Don't use sharp corners (< 8px radius) â€” the Meta Store is all smooth curves
- Don't mix product-specific accents (Ray-Ban Red with Quest Purple in the same section)
- Don't add decorative borders or ornamental dividers â€” dividers are functional only
- Don't place important text directly on photography without a gradient scrim
- Don't use weight 300 for anything smaller than 28px â€” it becomes too thin
- Don't use Facebook Blue (`#1877F2`) as a primary CTA color â€” use Meta Blue (`#0064E0`) instead
- Don't crowd product images â€” maintain generous padding around all photography
- Don't use more than 2 levels of text hierarchy in a single card
- Don't add drop shadows to cards in dark sections â€” rely on border and color separation
- Don't use long paragraphs â€” limit to 2-3 lines of body copy per block
...
3. Use natural language descriptions, not CSS values â€” "pill-shaped Meta Blue button" not "border-radius: 100px; background: #0064E0"
4. Describe the desired "feel" alongside specific measurements â€” "generous whitespace like a gallery" means 64-80px section padding
5. For dark sections, specify which product context (Quest dark `#181A1B`, pure black `#000000`, or standard dark `#1C1E21`)
6. Always specify the Optimistic VF weight explicitly (300, 400, 500, or 700) â€” each creates a dramatically different feel
