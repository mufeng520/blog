...
Binance.US radiates the polished urgency of a digital trading floor â€” a space where money moves and decisions happen in seconds. The design is a two-tone composition that alternates between stark white trading surfaces and deep near-black panels (`#222126`), creating a visual rhythm that mirrors the bull-and-bear duality of crypto markets. Binance Yellow (`#F0B90B`) cuts through this monochrome foundation like a gold ingot on a steel desk â€” unmistakable, confident, and engineered to guide every eye toward the next action.

The interface speaks the language of fintech trust. Custom BinancePlex typography gives every headline and data point a proprietary gravitas, while generous whitespace and restrained decoration keep the focus on numbers, charts, and call-to-action buttons. The design avoids visual complexity in favor of operational clarity â€” every element exists to either inform or convert. Product screenshots of the mobile trading app dominate the middle sections, presented on floating device mockups against golden gradients, reinforcing that this is a platform you carry with you.

What makes Binance.US distinctive is the tension between warmth and precision. The golden yellow brand color â€” warm, optimistic, almost celebratory â€” lives inside a system of cold, clinical grey text and razor-sharp borders. This isn't a playful fintech like Robinhood or a corporate fortress like Fidelity â€” it's a crypto-native platform that wraps cutting-edge trading technology in the visual language of established finance.

**Key Characteristics:**
- Two-tone light/dark section alternation â€” white surfaces for trust, dark panels for depth
...
- **Binance Yellow** (`#F0B90B`): The signature â€” primary CTA backgrounds, brand accent, active states, link color. The single most important color in the system
...
- **Active Yellow** (`#D0980B`): Darkened yellow for active/pressed button states â€” the "clicked" gold
- **Focus Blue** (`#1EAEDB`): Accessibility focus state â€” appears on hover and focus for all interactive elements
...
- **Binance Dark** (`#222126`): Dark section backgrounds, footer canvas, "Trusted by millions" panel â€” a near-black with a faint purple undertone
...
- **Primary Text** (`#1E2026`): Main body text, headings on light backgrounds â€” near-black with slight warmth
- **Secondary Text** (`#32313A`): Navigation links, descriptive copy on light surfaces
- **Slate** (`#848E9C`): Tertiary text, metadata, timestamps, footer links â€” the workhorse grey
- **Steel** (`#686A6C`): Disabled-adjacent text, subtle labels
- **Muted** (`#777E90`): Secondary navigation links, less prominent footer text
- **Hover Dark** (`#1A1A1A`): Universal link hover color â€” text darkens on hover
...
- **Golden Glow**: Radial gradient from `#F0B90B` center to `#F8D12F` edge â€” used behind product mockup screenshots
- **Dark Fade**: Linear gradient from `#222126` to transparent â€” used for dark section transitions
...
|------|------|--------|-------------|----------------|-------|
| Display Hero | 60px | 700 | 1.08 | â€” | Hero headlines, maximum impact |
| Display Secondary | 34px | 700 | 1.00 | â€” | Section titles on dark backgrounds |
| Heading 1 | 28px | 500 | 1.00 | â€” | Major section headings |
| Heading 2 | 24px | 700 | 1.00 | â€” | Feature headings, card titles |
| Heading 3 | 24px | 600 | 1.00 | â€” | Subsection headings |
| Heading 4 | 20px | 600 | 1.25 | â€” | Card headings, feature labels |
| Body Large | 20px | 500 | 1.50 | â€” | Hero subtitle, lead paragraphs |
| Body | 16px | 500 | 1.50 | â€” | Standard body text |
| Body SemiBold | 16px | 600 | 1.30 | â€” | Emphasized body, nav links |
| Body Bold | 16px | 700 | 1.50 | â€” | Strong emphasis text |
| Button | 16px | 600 | 1.25 | 0.16px | Primary button text |
| Button Small | 14.4px | 600 | 1.60 | 0.72px | Secondary buttons, wider tracking |
| Caption | 14px | 500 | 1.43 | â€” | Metadata, labels, prices |
| Caption SemiBold | 14px | 600 | 1.50 | â€” | Emphasized captions |
| Small | 12px | 600 | 1.00 | â€” | Tags, badges, fine print |
| Tiny | 11px | 500 | 1.00 | â€” | Micro-labels, chart annotations |

### Principles

BinancePlex is engineered for data-dense interfaces where numbers and text must coexist at multiple scales. The typeface has tabular numerals by default â€” critical for price columns and portfolio values that need perfect vertical alignment. Weights lean toward the heavier end (500-700), giving the interface a sense of authority and confidence that's essential for a financial platform. The tight line-heights (1.00-1.25) on headings create a stacked, compressed feel that mirrors the density of trading dashboards, while body text opens up to 1.50 for comfortable reading of educational and marketing content.
...
- Shadow: `rgba(32, 32, 37, 0.05) 0px 3px 5px 0px` â€” barely visible, trust-building
...
Binance.US uses whitespace as a trust signal. Generous padding around the hero section and between content blocks creates a sense of spaciousness that counters the information density typically associated with crypto exchanges. The light sections breathe â€” wide margins around headlines and ample spacing between cards â€” while dark sections compress, packing features into tighter grids to convey capability and depth. The overall rhythm alternates between "inviting entry" (light, spacious) and "deep functionality" (dark, dense).
...
Binance.US uses a whisper-light shadow system. Card shadows are barely perceptible at 5% opacity â€” they exist not for dramatic depth but as subtle ground cues that keep cards from feeling pasted onto the surface. The pill button shadow is the exception: slightly more visible to give CTAs a "floating" quality that invites clicks. The philosophy is pragmatic â€” in a financial context, heavy shadows feel frivolous, while no shadows at all feel flat and untrustworthy. The 5% sweet spot communicates professionalism.
...
- Use Binance Yellow (`#F0B90B`) exclusively for primary CTAs and brand accents â€” it's the single point of color
- Keep light and dark sections strictly alternating for visual rhythm
- Use BinancePlex at weight 500+ for all interactive elements â€” this is a confidence-forward design
- Apply 50px radius to all primary CTA pill buttons â€” the signature interactive shape
- Maintain 12px radius on content cards for a polished but not overly rounded feel
- Show real-time data prominently (prices, percentages, stats) â€” numbers build trust
- Use Slate (`#848E9C`) for all secondary/metadata text â€” the universal quiet voice
- Keep shadows at 5% opacity or less â€” barely there but present

### Don't

- Don't introduce additional brand colors â€” Binance Yellow is the only accent; all other color is data-driven (green up, red down)
- Don't use rounded corners above 12px on content cards â€” only CTAs and video containers go higher
- Don't add heavy shadows or hover lift effects â€” this is a restrained financial platform
- Don't use BinancePlex below weight 500 for headings â€” lighter weights undermine authority
- Don't place yellow text on yellow backgrounds â€” always ensure high contrast pairing
- Don't mix pill (50px) and square (6px) button styles in the same row
- Don't soften the dark sections â€” `#222126` should feel authoritative, not grey
- Don't use decorative illustrations â€” imagery should be product screenshots or data visualizations
- Don't add animation beyond subtle transitions (200ms ease) â€” financial platforms need stability
- Don't use colored backgrounds for semantic states in cards â€” keep cards white or dark, use text color for semantic meaning
...
- **Navigation**: Full horizontal links â†’ hamburger menu below 897px; logo and "Get Started" CTA remain visible
- **Hero section**: Side-by-side (text left, image right) â†’ stacked (text top, image below) at 768px
- **Feature grid**: 3-col â†’ 2-col at 768px â†’ 1-col at 600px
- **Price ticker**: Horizontal row â†’ wrapping or scrollable at 600px
- **Section padding**: 64px â†’ 48px â†’ 32px â†’ 16px as viewport narrows
- **Device mockups**: Scale down proportionally, maintain centered positioning
- **Footer**: Multi-column â†’ stacked accordion sections on mobile
...
3. Remember: Binance Yellow (#F0B90B) is the ONLY accent color â€” everything else is grey/dark/white
4. Use the dark/light section alternation for visual pacing
5. Numbers and data should be prominent â€” this is a financial platform
6. Pill buttons (50px radius) for CTAs, regular buttons (6px radius) for form actions
7. Keep shadows almost invisible (5% opacity) â€” trust comes from clarity, not depth
