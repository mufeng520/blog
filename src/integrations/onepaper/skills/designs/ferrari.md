...
Ferrari's website is a digital editorial â€” a curated magazine where the Prancing Horse brand is presented with the gravitas of an art institution and the precision of Italian coachwork. The page opens onto an expanse of absolute black, broken only by the iconic Prancing Horse emblem floating alone in its own atmosphere. Below, the content unfolds in dramatic alternations between inky-dark cinematic sections and crisp white editorial panels. This chiaroscuro rhythm â€” darkness yielding to light, machinery yielding to human story â€” feels more like paging through a Ferrari yearbook than scrolling a commercial website. Every section is a curated vignette: a concept car dissolving from shadow, two F1 drivers posed with sculptural stillness, a lineup of production models arranged in a jewel-toned parade.

The color language is monastically restrained for a brand built on speed and emotion. Ferrari Red (`#DA291C`) appears with almost surgical sparseness â€” reserved for the Subscribe CTA and accent moments that need to command immediate attention. The vast majority of the interface lives in black, white, and a carefully calibrated gray scale (from `#303030` dark surfaces through `#8F8F8F` mid-tones to `#D2D2D2` light borders). Two yellows â€” Racing Yellow (`#FFF200`) and the deeper Modena Yellow (`#F6E500`) â€” exist in the token system as heritage accents for special contexts, honoring Ferrari's racing provenance. The restraint means that when red does appear, it carries the weight of the entire brand.

Typography relies on FerrariSans â€” a proprietary sans-serif family with medium-weight headings (500â€“700) and compact proportions. Display text runs at 24â€“26px for section titles, while the UI chrome lives at 12â€“16px in weights ranging from regular to bold. A secondary "Body-Font" custom typeface handles captions and utility text, rendered in uppercase with wide letter-spacing (1px) to create a label-like editorial quality. This two-font system â€” FerrariSans for narrative authority, Body-Font for structural annotation â€” gives the site a print-magazine hierarchy. No text decoration is gratuitous. Letter-spacing is tight for headlines and deliberately expanded for labels, creating a visual rhythm that alternates between urgency and composure.

**Key Characteristics:**
- Chiaroscuro layout alternating between deep black sections and clean white editorial panels
- Ferrari Red (`#DA291C`) used with extreme sparseness â€” accent, not atmosphere
...
- Photo-journalism imagery: concept renders, driver portraits, lineup parades â€” each section is a story
...
### Primary
- **Ferrari Red** (`#DA291C`): The iconic Rosso Corsa â€” primary accent and CTA color. Used for the Subscribe button, key action triggers, and brand moments where maximum visual authority is needed. The single most important color in the system (--f-color-accent-100)
...
### Secondary & Accent
- **Dark Red** (`#B01E0A`): Deeper variant of Ferrari Red for hover/pressed states and high-contrast contexts â€” adds dimensionality to the brand color without introducing a new hue (--f-color-accent-90)
- **Deep Red** (`#9D2211`): The most saturated dark red â€” used for active states and extra emphasis where even Dark Red needs more weight (--f-color-accent-80)
- **Racing Yellow** (`#FFF200`): Heritage accent from Ferrari's racing livery â€” reserved for special highlights and motorsport-related contexts (--f-color-yellow-hypersail)
- **Modena Yellow** (`#F6E500`): Slightly warmer and more golden than Racing Yellow â€” used for secondary heritage accents and category markers (--f-color-yellow)

### Surface & Background
- **Absolute Black** (`#000000`): Hero sections, cinematic backgrounds, and the dominant dark surface â€” the void that makes imagery and the Prancing Horse emblem float
- **Dark Surface** (`#303030`): Secondary dark surface for footer regions, newsletter sections, and layered dark panels â€” slightly lifted from pure black for depth differentiation (--f-color-ui-90)
...
### Neutrals & Text
- **Near Black** (`#181818`): Primary body text color on light surfaces â€” slightly softened from absolute black for better readability (link default color)
- **Dark Gray** (`#666666`): Secondary text and subdued UI labels â€” used where text needs to recede from the primary hierarchy (--f-color-black-60)
...
### Semantic & Accent
- **Warning Red** (`#F13A2C`): Accessible warning state â€” brighter and more orange-shifted than Ferrari Red to differentiate semantic alerts from brand expression (--f-color-accessible-warning)
...
- **Link Hover Blue** (`#3860BE`): Interactive hover state for text links â€” a dignified navy-blue that signals interactivity without competing with Ferrari Red
...
### Principles
- **Proprietary identity**: FerrariSans is exclusive to Ferrari â€” it cannot be substituted without losing brand recognition. The font's compact proportions and medium weight default (500) convey engineering precision
- **Two-register system**: FerrariSans handles narrative voice (headings, content, buttons) while Body-Font handles structural annotation (labels, tags, micro-captions) â€” this mirrors print magazine conventions of editorial text vs. technical labels
...
- **Compact line-heights**: Headlines use tight line-heights (1.00â€“1.30) creating dense, impactful text blocks, while body text opens to 1.50 for comfortable reading â€” the contrast between compressed headers and relaxed body text creates visual tension
- **Weight range 400â€“700**: Four weights active in the system (400, 500, 600, 700) â€” significantly more range than Tesla but still controlled. 500 is the default "voice," 700 is for emphasis, 400 for body, 600 for navigation

## 4. Component Stylings

### Buttons
Ferrari's buttons are minimal white rectangles with near-zero radius â€” the CTA philosophy is "architecture, not decoration."

**Primary CTA (White)** â€” The default action button:
...
**Subscribe CTA (Red)** â€” The high-emphasis action button:
...
- The only button that uses Ferrari Red â€” reserved for maximum visual priority

**Ghost Button (White Border)** â€” For dark backgrounds:
...
- Text: FerrariSans heading (16â€“24px) + Body-Font caption (12â€“13px uppercase)

**Dark Cinematic Card** (Hero/feature sections):
- Background: `#000000` (Absolute Black)
- Full-bleed imagery with text overlay
- No border, no shadow â€” the darkness IS the container
...
### Navigation
- **Desktop**: Prancing Horse logo centered at top of page, primary navigation below â€” not a traditional horizontal nav bar but a full-width header block on black background
- **Logo**: Centered Prancing Horse emblem (44Ã—42px) on absolute black â€” the single most prominent UI element
...
- **No sticky nav behavior** observed â€” the page scrolls naturally with the header moving off-screen

### Image Treatment
- **Hero**: Full-width editorial photography on black backgrounds â€” concept cars in atmospheric studio lighting, editorial portraits with cinematic composition
- **Aspect ratios**: Mixed â€” landscape (16:9) for hero sections, near-square for portrait/driver imagery, wide panoramic for vehicle lineups
...
- **Image quality**: High-resolution photography with studio lighting â€” no user-generated or lifestyle imagery. Every image is art-directed
...
- Content: mixed editorial â€” event recaps, model launches, racing highlights
...
- **Button padding**: 12px vertical, 10px horizontal â€” compact and precise
- **Section padding**: Generous vertical spacing (40â€“80px estimated) between major content blocks
- **Card gaps**: 16â€“20px between grid items
...
| Level 1 (Subtle) | `rgb(153, 153, 153) 1px 1px 1px 0px` | Rare â€” cookie consent dialogs and dropdown menus |
| Level 2 (Overlay) | `hsla(0, 0%, 7%, 0.8)` backdrop | Modal overlays and image caption backgrounds |
| Level 3 (Border) | `1px solid #CCCCCC` | Input fields, form containers â€” depth through delineation not shadow |

### Shadow Philosophy
Ferrari's approach to elevation is nearly as flat as Tesla's, but with a different rationale. Where Tesla avoids shadows for minimalism, Ferrari avoids them because the editorial photography provides all the visual depth needed. The single shadow token (`rgb(153, 153, 153) 1px 1px 1px 0px`) is extremely subtle â€” a 1-pixel whisper used only in utilitarian contexts like consent dialogs. The site communicates hierarchy through three strategies:
...
- The Prancing Horse logo on black creates a "floating in void" effect through pure contrast â€” no glow or shadow needed
- Dark-to-light section transitions are hard cuts, not gradient blends â€” reinforcing the editorial page-turn metaphor

## 7. Do's and Don'ts

### Do
- Use Ferrari Red (`#DA291C`) sparingly â€” only for primary CTAs and brand-critical moments. Its power comes from restraint
- Alternate between black cinematic sections and white editorial sections to create the signature chiaroscuro rhythm
- Use FerrariSans at weight 500 as the default heading voice â€” it's the typographic equivalent of the engine note
- Apply Body-Font in uppercase with 1px letter-spacing for all labels, category tags, and structural annotations
- Keep border-radius at 2px for all interactive elements â€” razor precision, not rounded friendliness
- Let photography carry the emotional weight â€” every image should be art-directed studio quality
- Use the Prancing Horse emblem as a standalone hero element on black â€” never crowd it with adjacent content
- Maintain the 12px/10px button padding ratio â€” compact, purposeful, no excess
- Use `#181818` (Near Black) for body text instead of pure `#000000` â€” the subtle warmth improves readability
- Reserve the yellow accents (`#FFF200`, `#F6E500`) strictly for motorsport and racing heritage contexts

### Don't
- Scatter Ferrari Red across the interface as decoration â€” it's a CTA signal, not a theme color
- Use rounded-pill buttons or large border-radii â€” the 2px precision is non-negotiable
- Add box-shadows to cards or content containers â€” depth comes from surface color contrast and photography
- Mix FerrariSans and Body-Font within the same text block â€” they serve separate hierarchical functions
- Use colorful backgrounds (blue, green, etc.) for sections â€” the palette is exclusively black/white/gray with red and yellow accents
- Apply text transforms to FerrariSans headings â€” uppercase is reserved for Body-Font labels only
- Display low-quality or user-generated imagery â€” every photograph must meet editorial standards
- Use the Link Hover Blue (`#3860BE`) for anything other than interactive hover states â€” it's not a brand color
- Create busy layouts with multiple competing focal points â€” each section should have one clear story
- Override the semantic color system (warning, success, info) with brand colors â€” `#F13A2C` warning is deliberately different from `#DA291C` brand red
...
|------|-------|-------------|
| Mobile Small | â‰¤375px | Single-column, minimal padding (12px), stacked navigation, hero text scales to ~18px, full-width CTAs |
| Mobile | 376â€“600px | Single-column, slightly larger padding (16px), hamburger nav, body text at 13px |
| Tablet Small | 601â€“768px | 2-column editorial grid begins, hero images maintain full-width, footer switches to 2-column |
| Tablet | 769â€“960px | Full 2-column layout, carousel shows 3 vehicles, padding increases to 20px |
| Desktop | 961â€“1280px | Full navigation, 2-column editorial with larger imagery, vehicle lineup shows 5 models |
| Large Desktop | 1281â€“1920px | Maximum content width, generous whitespace, hero photography at full cinematic scale |

### Touch Targets
- Primary CTA buttons: minimum 44px height with 12px vertical padding (meets WCAG AAA 44Ã—44px target)
...
- Footer links: grouped with sufficient vertical spacing (16â€“20px) for touch accuracy
...
- **Vehicle lineup**: Horizontal carousel maintains scroll behavior but reduces visible models from 5 to 2â€“3
...
- **Spacing reduction**: Section padding reduces from 40â€“80px (desktop) to 20â€“40px (mobile), maintaining proportional breathing room
...
- "Build an editorial card on white background with a full-width image (16:9 ratio) above, a FerrariSans heading (16px/700, Near Black #181818) below, and a Body-Font uppercase label (11px, 1px letter-spacing, Mid Gray #8F8F8F) as the category tag â€” no border, no shadow, no border-radius"
...
1. Focus on ONE component at a time â€” Ferrari's editorial rhythm means each section is a self-contained vignette
2. Reference specific color names and hex codes from this document â€” the palette is small but each color has a precise role
3. Use natural language descriptions, not CSS values â€” "razor-sharp 2px corners" conveys intent better than "border-radius: 2px"
4. Describe the desired "feel" alongside specific measurements â€” "editorial magazine page-turn between sections" communicates the layout philosophy better than "margin-bottom: 80px"
5. Always maintain the chiaroscuro contrast â€” if a section feels flat, check whether it needs to be on black or white to maintain the alternating rhythm
6. Reserve Ferrari Red for ONE element per screen â€” if red appears in more than one place, it loses its authority
